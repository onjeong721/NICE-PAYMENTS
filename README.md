# NICE PAYMENTS 디자인클론코딩
<br>

## 프로젝트 명
  NICE PAYMENTS 홈페이지 디자인클론코딩

## 프로젝트 기간
  202.  .  ~

## 프로젝트 목표
- 홈페이지 타이틀 background에 영상 첨부
...
>#### 나이스 페이먼츠
  + 주소: http://www.nicepayments.co.kr/kor/main/main.html
  + 분야(업종): 금융서비스
...
>#### 폰트
+ "SUIT",-apple-system,BlinkMacSystemFont,"Segoe UI",Roboto,"Helvetica Neue",Arial,"Noto Sans",sans-serif,"Apple Color Emoji","Segoe UI Emoji","Segoe UI Symbol","Noto Color Emoji"
